        ...
        <section className='mb-5'>
            ...
            <div className='mt-4'>
                ...
                <div className='text-center'>
                    ...
                    <a href={liveLink} style={linkStyle} target="_blank" className='btn btn-outline-secondary fw-bold m-2' rel="noopener noreferrer">
                        <FontAwesomeIcon className='me-2 fs-5 text-white' icon={faGlobe} />LIVE
                    </a>

                    <a href={githubLink} target='_blank' className="btn btn-outline-secondary fw-bold m-2" rel="noopener noreferrer">
                        <FontAwesomeIcon className='me-2 fs-5 text-white' icon={faGithub} />GITHUB
                    </a>
